...
var IPomelo = /** @class */ (function (_super) {
    __extends(IPomelo, _super);
    function IPomelo() {
...
var ServerImplemented = /** @class */ (function () {
    ...
    ServerImplemented.prototype.listenForPomeloEvents = function () {
        var _this = this;
    ...
    ServerImplemented.prototype.signin = function (msg) {
        var self = this;
    ...
    ServerImplemented.prototype.LeaveChatRoomRequest = function (token, roomId, callback) {
        var self = this;
        var msg = {};
        msg["token"] = token;
        msg["rid"] = roomId;
