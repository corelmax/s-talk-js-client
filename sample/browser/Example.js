    ...
    var Factory = /** @class */ (function () {
        ...
        Factory.prototype.stalkInit = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, index_1.StalkJS.init(this.stalk)];
                        case 1:
                            socket = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            ;
                            return [4 /*yield*/, index_1.StalkJS.geteEnter(this.stalk, msg)];
                        case 1:
                            connector = _a.sent();
                            params = { host: connector.host, port: connector.port, reconnect: false };
                            return [4 /*yield*/, index_1.StalkJS.handshake(this.stalk, params)];
                        case 2:
                            _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            msg["x-api-key"] = ""; /* your api key*/
                            ;
                            return [4 /*yield*/, index_1.StalkJS.checkIn(this.stalk, msg)];
                        case 1:
                            result = _a.sent();
        ...
        Factory.prototype.checkOut = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, index_1.StalkJS.checkOut(this.stalk)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
