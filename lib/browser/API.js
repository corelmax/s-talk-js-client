...
(function (API) {
            ...
            var result = new Promise(function (resolve, rejected) {
                if (!!socket && self.server._isConnected === false) {
                    ...
                    socket.request("gate.gateHandler.queryEntry", msg, function (result) {
                        ...
                        if (result.code === index_1.HttpStatusCode.success) {
    ...
    var LobbyAPI = /** @class */ (function () {
         ...
         * @param msg
         */
        LobbyAPI.prototype.updateUser = function (msg) {
        ...
        LobbyAPI.prototype.getUsersPayload = function (msg) {
            var self = this;
            var socket = this.server.getSocket();
            return new Promise(function (resolve, rejected) {
                // <!-- Authentication.
                try {
                    socket.request("connector.entryHandler.getUsersPayload", msg, function (res) {
                        resolve(res);
                    });
                }
                catch (ex) {
        ...
        LobbyAPI.prototype.kickMeAllSession = function (uid) {
            var self = this;
            var socket = this.server.getSocket();
            if (socket !== null) {
                var msg = { uid: uid };
     ...
     */
    var CallingAPI = /** @class */ (function () {
        function CallingAPI(_server) {
            this.server = _server;
        }
        CallingAPI.prototype.calling = function (api_key, event, members, payload) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                var _message;
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, rejected) {
                            try {
                                var socket = _this.server.getSocket();
                                socket.request("connector.entryHandler.calling", _message, function (result) {
                                    if (result.code == 200) {
                                        resolve(result);
                                    }
                                    else {
