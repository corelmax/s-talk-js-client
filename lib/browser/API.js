...
(function (API) {
    ...
    var CallingAPI = (function () {
        ...
        CallingAPI.prototype.callingRequest = function (members, event, api_key, payload) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                var _message;
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, rejected) {
                            try {
                                var socket = _this.server.getSocket();
                                socket.request("connector.entryHandler.callingRequest", _message, function (result) {
                                    if (result.code == 200) {
                                        resolve(result);
                                    }
                                    else {
